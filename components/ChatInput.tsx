    ...
    <div className="px-4 py-3 bg-white border-t border-gray-100">
      <div className="flex items-center gap-2 bg-gray-100 rounded-full px-4 py-2">
        ...
        <button
          ...
          className="shrink-0 w-8 h-8 rounded-full bg-[#008035] hover:bg-[#006828] disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-all"
          aria-label="Send"
        >
          {isLoading ? (
